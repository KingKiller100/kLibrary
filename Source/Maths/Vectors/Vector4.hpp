...
namespace kmaths
{
	...
	public:
		...
		USE_RESULT constexpr Type& Z() noexcept { return z; }
		USE_RESULT constexpr const Type& Z() const noexcept { return z; }

		USE_RESULT constexpr Type& W() noexcept { return w; }
		USE_RESULT constexpr const Type& W() const noexcept { return w; }
